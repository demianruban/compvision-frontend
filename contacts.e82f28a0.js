...
function sendImg() {
  ...
  */ const imgUrl = document.getElementById("image-url").value;
    ...
    if (!imgUrl) throw new Error("No URL passed");
        ...
        .then((response)=>response.json()).then(processResponse).catch((err)=>console.error(err));
    }
}
function processResponse(response) {
    ...
    while(imageInfoDiv.childNodes.length > 5)imageInfoDiv.removeChild(imageInfoDiv.lastChild);
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["eZyLq","dV6cC"], "dV6cC", "parcelRequire5698")

//# sourceMappingURL=contacts.e82f28a0.js.map
